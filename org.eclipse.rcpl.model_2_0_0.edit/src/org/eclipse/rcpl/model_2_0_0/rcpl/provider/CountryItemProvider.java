 ...
 * {@link org.eclipse.rcpl.model_2_0_0.rcpl.Country} object. <!-- begin-user-doc
 * --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class CountryItemProvider extends LayoutableItemProvider {
	...
	protected void addWorldregionsPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Country_worldregions_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Country_worldregions_feature",
								"_UI_Country_type"),
						RcplPackage.Literals.COUNTRY__WORLDREGIONS, true, false, true, null, null, null));
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors
				.add(createChildParameter(RcplPackage.Literals.COUNTRY__CITIES, RcplFactory.eINSTANCE.createCity()));
	}
