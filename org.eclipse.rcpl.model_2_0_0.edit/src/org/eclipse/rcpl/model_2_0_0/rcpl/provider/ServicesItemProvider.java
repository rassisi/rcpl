...
/**
 * This is the item provider adapter for a {@link org.eclipse.rcpl.model_2_0_0.rcpl.Services} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ServicesItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(RcplPackage.Literals.SERVICES__CHILDREN);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Services.class)) {
			case RcplPackage.SERVICES__CHILDREN:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(RcplPackage.Literals.SERVICES__CHILDREN,
				 RcplFactory.eINSTANCE.createService()));
	}
