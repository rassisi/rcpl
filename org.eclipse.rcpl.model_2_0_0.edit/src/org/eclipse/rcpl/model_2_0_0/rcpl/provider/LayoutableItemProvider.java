 ...
 * {@link org.eclipse.rcpl.model_2_0_0.rcpl.Layoutable} object. <!--
 * begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class LayoutableItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	public String getText(Object object) {
		...
		return getClass().getSimpleName().replaceAll("ItemProvider", "");

		// String label = ((Layoutable)object).getName();
		// return label == null || label.length() == 0 ?
		// getString("_UI_Layoutable_type") :
