 ...
 *
 */
public class RcplScredentialRepository implements ICredentialRepository {

	// Simulates database of users!
	private Map<String, UserInfo> userDatabase = new HashMap<String, UserInfo>();

	public static void main(String[] args) throws Exception {
		RcplScredentialRepository passManager = new RcplScredentialRepository();
	...
	public String getEncryptedPassword(String password, String salt) throws Exception {
		...
		int derivedKeyLength = 256; // 160; // for SHA1
		int iterations = 10000; // NIST specifies 10000
	...
	public String getSecretKey(String userName) {
		UserInfo result = userDatabase.get(userName);
		return result.userEncryptedPassword;
	}
