 ...
 * 
 */
public class DefaultTutorialsHomePage extends AbstractHomePage implements IHomePage {

	public DefaultTutorialsHomePage(IRcplUic uic, HomePage modelHomePage, Pane pane) {
		super(uic, modelHomePage, pane);
	}

	@Override
	public EnCommandId getId() {
		return EnCommandId.HOME_PAGE_TUTORIALS;
	}
