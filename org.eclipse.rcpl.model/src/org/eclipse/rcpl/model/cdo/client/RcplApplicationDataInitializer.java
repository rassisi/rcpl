...
//		
//		cdoSession.getCoreData().setDefaultLanguage(language);
//		Currency currency = (Currency) cdoSession.findCurrency("EUR");
//		cdoSession.getCoreData().setDefaultCurrency(currency);
	}
